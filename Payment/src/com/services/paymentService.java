...
public class paymentService {
	...
	Connection con = dbconnector.connecter();
	...
	public String insertCreditCardInfo(String cardNo, String cvv, String ccHolderName, String ccExpDate, String paymentID) {
		...
		try {
			...
			String query = " insert into creditcardetails (`cardNo`, `cvv`,`ccHolderName`,`ccExpDate`,`paymentID` )" + " values (?, ?, ?, ?, ?)";
	...
	public String readPayments() {
		...
		try {
			...
			while (rs.next()) {
				...
				output += "<td><button class=\"btn\">Update</button> </td>";
				output += "</tr>";
			}
			output += "</table>";
		} catch (Exception e) {
	...
	public String readCCInfoAccordingToPaymentID(String paymentID) {
		...
		try {
			...
			String query = "select * from creditcardetails where paymentID = " + paymentID;
			Statement stmt = con.createStatement();
			ResultSet rs = stmt.executeQuery(query);
	...
	public String updateCreditCardInfo(int CCID, String cardNo, String cvv, String ccHolderName, String ccExpDate, String paymentID) {
		...
		try {
			...
			String query = "UPDATE creditcardetails SET  cardNo= ?, cvv= ?, ccHolderName= ?, ccExpDate= ?, paymentID= ? WHERE CCID= ?";
